  ...
  <div class="header" id="topheader">
      ...
      <div class="container text-uppercase p-2">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Teacherreg">AddTeacher</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="createcourse">createcourse</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="createclass">createclass</a>
            </li>
            <li class="nav-item">
    ...
    <section class="header-section">
      <div class="center-div">
        <h1 class="font-weight-bold">Welcome ${aname}</h1>
