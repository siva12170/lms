        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="StudentDash">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="acreg">Academic Registration</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="studentattendance">Attendance</a>
            </li>
